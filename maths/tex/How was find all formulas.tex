...
\begin{document}
    ...
    \section*{Index}
        ...
        \textbf{1. Initial part \hspace{10cm} 5}
            ...
            \textcolor{white}{a} \hspace{1cm} \textbf{1.2. Error Zone \hspace{8.49cm}7}
        \textbf{2. Algebra \hspace{10.55cm} 9}
            \textcolor{white}{a} \hspace{1cm} \textbf{2.1. Linear algebra \hspace{7.9cm}9}
                \textcolor{white}{a} \hspace{2cm} \textbf{2.1.1. Summation \hspace{7.05cm}9}
            \textcolor{white}{a} \hspace{1cm} \textbf{2.2. Elementary algebra \hspace{6.9cm} 10}
                \textcolor{white}{a} \hspace{2cm} \textbf{2.2.1. Notable Identities \hspace{5.85cm} 10}
                \textcolor{white}{a} \hspace{2cm} \textbf{2.2.2. Property of Fractions \hspace{5.27cm} 11}
                \textcolor{white}{a} \hspace{2cm} \textbf{2.2.3. Property of multiplications \hspace{4.3cm} 12}
        \textbf{3. Mathematical analysis \hspace{8.05cm} 13}
            \textcolor{white}{a} \hspace{1cm} \textbf{3.1. Calculus \hspace{8.9cm}13}
                \textcolor{white}{a} \hspace{2cm} \textbf{2.1.1. Limits \hspace{7.95cm}13}
                \textcolor{white}{a} \hspace{2cm} \textbf{2.1.2. Derivative \hspace{7.25cm}14}
                \textcolor{white}{a} \hspace{2cm} \textbf{2.1.3. Integral \hspace{7.65cm}18}
        \textbf{4. Final Part \hspace{10.25cm}19}
            \textcolor{white}{a} \hspace{1cm} \textbf{4.1. Reference \hspace{8.65cm}19}
            \textcolor{white}{a} \hspace{1cm} \textbf{4.2. Make by \hspace{8.9cm}19}
            ...
            \subsection{A free owl project}
                ...
                \subsubsection{Differentiation of other projects}
                    \begin{itemize}
                        ...
                        \item This project respects the work of all people, so while it is allowed to include changes, you must demonstrate why the information was wrong.
    ...
    Note: it has been create a new version of this book. In the index you can just click and will move you to the part you want and the properties use in the equations you will see the id of the property you click it and will move you to the demonstration of the formula use.
    
    Link to that version: \url{https://github.com/White-Mask-230/A-free-owl}
    The two versions will have the same content and the two will be modified at the same time.
        ...
        \section{Linear algebra}
            \subsection{Summation}
                ...
                \subsubsection{Change limits}
                    ...
                    Subtraction superior limit add elements (id 2.3) (*)
                    \[\sum^n_{i=j}f(i) = f(j) + f(j + 1) + \cdots + f(n - 2) + f(n - 1) + f(n)\]
                    \[= f(n) + \sum^{n - 1}_{i=j}f(i)\]

                    Subtraction inferior limit add elements (id 2.4) (*)
                    \[\sum^n_{i=j}f(i) = f(j) + f(j + 1) + f(j + 2) + \cdots + f(n - 1) + f(n)\]
                    \[= f(j) + \sum^{n}_{i=j+1} f(i)\]
        ...
        \section{Calculus}
            ...
            \subsection{Integrals}
                \subsubsection{Constants}
                    ...
                    \[\int^b_a dx \cdot C = \lim_{n \rightarrow \infty} \frac{b - a}{n} \sum^n_{i=1} C\]
                    \[= \lim_{n \rightarrow \infty} \frac{b - a}{n} \cdot C \cdot n\]
                    \[= C(b - a)\]
                ...
                \subsubsection{Arithmetic Operations}
                    ...
                    \[\int^b_a dx \cdot x = \lim_{n \rightarrow \infty} \frac{b - a}{n} \sum^n_{i=1} a + i \frac{b - a}{n}\]
                    \[= \lim_{n \rightarrow \infty} \left[\sum^n_{i=1} a + \sum^n_{i=1} i \frac{b - a}{n}\right]\]
                    \[= \lim_{n \rightarrow \infty} \frac{b - a}{n} \left[a \cdot n + \frac{b - a}{n} \sum^n_{i=1} i \right]\]
                    \[= \lim_{n \rightarrow \infty} \frac{b - a}{n} \left[a \cdot n + \frac{b - a}{n} \cdot n \cdot \frac{n + 1}{2}\right]\]
                    \[= \lim_{n \rightarrow \infty} \frac{b - a}{n} \left[a \cdot n + \frac{(b - a)(n + 1)}{2}\right]\]
                    \[= \lim_{n \rightarrow \infty} \frac{b - a}{n} \left[a \cdot n + \frac{b \cdot n + b - a \cdot n + a}{2}\right]\]
                    \[= \lim_{n \rightarrow \infty} \frac{b - a}{n} \left[a \cdot n + \frac{n (b - a) + b + a}{2}\right]\]
                    \[= a(b - a) + \frac{(b - a)^2}{2} + \lim_{n \rightarrow \infty} \frac{b + a}{2 n}\]
                    \[= a(b - a) + \frac{(b - a)^2}{2}\]
                    \[= \frac{2a(b - a) + (b - a)^2}{2}\]
                    \[= \frac{2 \cdot a \cdot b - 2a^2 + b^2 - 2 \cdot b \cdot a + a^2}{2}\]
                    \[= \frac{b^2 - a^2}{2}\]
