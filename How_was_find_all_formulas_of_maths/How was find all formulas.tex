...
\NewId{DefinitionSummation}{2}
\NewId{IndexShift}{2}
\NewId{SubtractionSuperiorLimit}{2}
\NewId{SubtractionInferiorLimit}{2}
\NewId{SummationAdditionFunctions}{2}
\NewId{SummationConstant}{2}
\NewId{SummationConstantMultiplication}{2}
\NewId{DefinitionProduct}{2}
\NewId{ProductConstant}{2}
\NewId{ProductFunctionConstant}{2}
\NewId{ProductFunctions}{2}
\NewId{DefinitionFactorial}{2}
\NewId{SquareSummationDifference}{2}
\NewId{SumDifference}{2}
\NewId{AdditionTwoFractions}{2}
\NewId{FractionOfFraction}{2}
\NewId{SummationTwoFractionsSame}{2}
\NewId{DefinitionMultiplication}{2}
\NewId{DistributiveProperty}{2}
\NewId{MultiplicationDivisionSame}{2}
\NewId{RaisedToDefinition}{2}
\NewId{ValueXRaisedToZero}{2}
\NewId{ValueXRaisedPlus}{2}

\NewId{LimitConstant}{3}
\NewId{LimitToHim}{3}
\NewId{LimitConstantFuntion}{3}
\NewId{LimitSummationFunctions}{3}
\NewId{LimitFunctionsMultiply}{3}
\NewId{LimitDivideFunctions}{3}
\NewId{LimitCompositeFunction}{3}
\NewId{SqueezeTheorem}{3}
\NewId{LimitDefinitionDerivative}{3}
\NewId{DefinitionIntegral}{3}
\NewId{RelationSummationLimit}{3}
\NewId{DerivativeConstantMultiply}{3}
\NewId{DerivativeConstant}{3}
\NewId{DerivativeAdditionFunction}{3}
\NewId{DerivativeMultiplyFunctions}{3}
    ...
    \chapter{Algebra}
        ...
        \section{Elementary Algebra}
            ...
            \subsection{Property of Fractions}
                ...
                \[= \frac{a \cdot d + c \cdot b}{b \cdot d} \hspace{1cm} ()\]

                Fraction of a fraction (id \FractionOfFraction) (+)
                \[\frac{a}{\frac{b}{\frac{c}{d}}} = \frac{a \cdot d}{\frac{b \cdot c}{\frac{c \cdot d}{d \cdot c}}}\]
                \[= \frac{a \cdot d}{b \cdot c} \hspace{1cm} ()\]

                Summation of two fractions with same divisor (id \SummationTwoFractionsSame) (*)
                \[\frac{a}{b} + \frac{c}{b} = \frac{1}{b} \cdot a + c \cdot \frac{1}{b} \hspace{1cm} (2.13)\]
                \[= \frac{1}{b} (a + c) \hspace{1cm} (2.14)\]
                \[= \frac{a + c}{b} \hspace{1cm} (2.13)\]
            ...
            \subsection{Property of multiplications}
                ...
                \[a \cdot b = \sum^a_{i=1}b \hspace{1cm}\]
                ...
                \[= \frac{2}{a} + \sum^{a - 2}_{i=1} \frac{1}{a} \hspace{1cm} (2.12)(2.3)\]
                \[\vdots\]
                \[= \frac{a}{a}\]
                \[= 1\]
        ...
        \section{Calculus}
            ...
            \subsection{Derivative}
                ...
                \subsubsection{Arithmetic Operations}
                    ...
                    \[= \binom{n}{1} n \cdot f^{n - 1}(x) \hspace{1cm} (?)\]
                    \[= n \cdot f^{n - 1}(x)\]
