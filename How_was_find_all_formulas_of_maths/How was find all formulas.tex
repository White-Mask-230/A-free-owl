...
\NewId{IntegralFunctionElevate}{3} %25
\NewId{IntegralSummation}{3} %26
    ...
    \chapter{Algebra}
        ...
        \section{Elementary Algebra}
            ...
            \subsection{Property of Fractions}
                ...
                Divide a with a (id \DivideAWithA) (*)
                \[\frac{a}{a} = a \cdot \frac{1}{a} \hspace{1cm} (\MultiplyFraction)\]
        ...
        \section{Calculus}
            ...
            \subsection{Integrals}
                ...
                \subsubsection{Arithmetic Operations}
                    ...
                    Integral of a function elevate to 1 (id \IntegralFunctionElevate) (?)
