...
\NewId{AdditionTwoFractions}{2} %16
\NewId{FractionOfFraction}{2} %17
\NewId{SummationTwoFractionsSame}{2} %18
\NewId{DefinitionMultiplication}{2} %19
\NewId{DistributiveProperty}{2} %20
\NewId{MultiplicationDivisionSame}{2} %21
\NewId{RaisedToDefinition}{2} %22
\NewId{ValueXRaisedToZero}{2} %23
\NewId{ValueXRaisedPlus}{2} %24
    ...
    \chapter{Algebra}
        ...
        \section{Elementary Algebra}
            ...
            \subsection{Property of raised to}
                ...
                \[x^{a + 1} = \Pi^{a + 1}_{i=m} x \hspace{1cm} (\ProductConstant)\]
                \[= x\Pi^{a}_{i=m}x \hspace{1cm} (\RemoveOneTopLimit)\]
